...
(function(factory) {
   ...
   ********************/
        ...
        _updateDialCode: function(newDialCode, hasSelectedListItem) {
            var inputVal = this.telInput.val().replace(" ",""), newNumber;
            // save having to pass this every time
    
          //  newNumber = newNumber!=undefined? newNumber.replace(" ",""): newNumber;
            newDialCode = "+" + newDialCode.replace(" ","") +" ";
          ...
          //  this.telInput[0].value = newNumber;
